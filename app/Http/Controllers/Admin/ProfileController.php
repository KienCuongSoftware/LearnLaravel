...
{
    private const OTP_VERIFIED_UNTIL_SESSION_KEY = 'admin.profile.password_otp_verified_until';

    private const DELETE_CONFIRMED_AT_SESSION_KEY = 'admin.profile.delete.confirmed_at';

    private const DELETE_CONFIRMED_USER_ID_SESSION_KEY = 'admin.profile.delete.confirmed_user_id';
    ...
    public function startPasswordOtp(Request $request, ProfilePasswordOtpService $otpService)
    {
        ...
        return redirect()->route('admin.profile.password.otp.notice')
    ...
    public function showPasswordOtpForm(Request $request)
    {
        ...
        return view('admin.profile.password-otp', compact('user'));
    }
    ...
    public function showDeleteConfirm()
    {
        ...
        return view('admin.profile.delete-confirm', compact('user', 'confirmText'));
    }
    ...
    public function startDeleteOtp(Request $request, AccountDeletionOtpService $otpService)
    {
        ...
        return redirect()->route('admin.profile.delete.otp.notice')
    ...
    public function showDeleteOtpForm(Request $request)
    {
        ...
        if (! $this->deleteFlowAllowed($request, $user)) {
            return redirect()->route('admin.profile.delete.confirm')
                ->with('error', 'Vui lòng xác nhận cảnh báo trước khi nhập OTP.');
        }

        return view('admin.profile.delete-otp', compact('user'));
    }
