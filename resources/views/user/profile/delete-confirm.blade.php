...
<div class="card mx-auto border-danger" style="max-width: 860px;">
    <div class="card-body">
        <div class="alert alert-warning mb-3">
            <strong>Cảnh báo:</strong> thao tác này sẽ xóa vĩnh viễn tài khoản, thông tin hồ sơ và quyền truy cập.
        </div>
        <ul class="mb-3">
        ...
        <form action="{{ route('profile.delete.start') }}" method="POST">
            @csrf
