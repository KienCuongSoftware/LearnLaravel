...
@section('title', 'Xóa tài khoản nhân viên')

@section('content')
<div class="page-header">
    <h2>Xóa tài khoản</h2>
    <a class="btn btn-outline-secondary" href="{{ route('staff.profile.edit') }}">Quay lại hồ sơ</a>
</div>
...
<div class="card shadow-sm border-danger">
    <div class="card-body">
        ...
        <ul class="mb-3">
            ...
            <li>Bạn sẽ bị đăng xuất ngay lập tức khỏi khu vực nhân viên.</li>
        ...
        <form action="{{ route('staff.profile.delete.start') }}" method="POST">
            @csrf
